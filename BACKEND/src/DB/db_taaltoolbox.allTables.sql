...
CREATE TABLE "Taaltoolbox"."school" (
  id_school SERIAL,
  name varchar(45) NOT NULL,
  description varchar(120),
...
CREATE TABLE "Taaltoolbox"."schoolclass" (
  id_schoolclass SERIAL,
  name varchar(45) NOT NULL,
  description varchar(120),
...
--liste des niveaux de maîtrise par le joueur
CREATE TABLE "Taaltoolbox"."proficiency" (
  id_proficiency char(4) NOT NULL,
  name varchar(45) NOT NULL,
  description varchar(120),
  weight int NOT NULL, 
...
CREATE TABLE "Taaltoolbox"."card" (
  ...
  id_learn_domain int, 
  id_category int, 
  id_lang char(2),										-- EN,NL,FR, langue d'entraînement
  PRIMARY KEY (id_card),
...
CREATE TABLE "Taaltoolbox"."users" (
  ...
  id_lang int NOT NULL,										-- langue maternelle de l'utilisateur
  id_school int,
  id_schoolclass int,
  PRIMARY KEY (id_user),
