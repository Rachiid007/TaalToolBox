...
export class CreateTable1671232640211 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "users" ("id" SERIAL NOT NULL, "name" character varying, "surname" character varying, "firstName" character varying, "lastName" character varying, "email" character varying, "schoolEmail" character varying NOT NULL, "privateEmail" character varying NOT NULL, "password" character varying, "birthdate" date NOT NULL, "phone" character varying, "sex" character varying, "langId" integer, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "drag_and_drop" ("id" SERIAL NOT NULL, "leveldata" character varying NOT NULL, "levelname" character varying NOT NULL, "creator" character varying NOT NULL, "image" character varying, CONSTRAINT "PK_da2902e03c38a256d2a35a93dd2" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `CREATE TABLE "proficiency" ("id_proficiency" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying NOT NULL, "weight" integer NOT NULL, CONSTRAINT "PK_dbf747becabff5fdce52b2d724f" PRIMARY KEY ("id_proficiency"))`,
    );
    await queryRunner.query(
