<script setup lang="ts">
  // il n'y a que ceux ayant le profil créateur qui peuvent ajouter des activités
  import { ref } from 'vue'
  ...
  const listActivities = [
    {
      ...
      url: new URL('/src/assets/logo/flashcards.svg', import.meta.url) as any,
      description:
    ...
    },
    {
      ...
      url: new URL('/src/assets/logo/dalcard.svg', import.meta.url) as any,
      description:
